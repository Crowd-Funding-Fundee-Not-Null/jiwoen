      ...
      <div class="container ">
        <div class="row">
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="<%=cp %>/resources/images/o1.jpg" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Tasty Thursdays
          ...
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="<%=cp %>/resources/images/o2.jpg" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Pizza Days
  ...
  <section class="about_section layout_padding">
    <div class="container  ">
      ...
      <div class="row">
        <div class="col-md-6 ">
          <div class="img-box">
            <img src="<%=cp %>/resources/images/about-img.png" alt="">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
        ...
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="<%=cp %>/resources/images/client1.jpg" alt="" class="box-img">
              </div>
            </div>
          </div>
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="<%=cp %>/resources/images/client2.jpg" alt="" class="box-img">
              </div>
            </div>
          </div>
        </div>
