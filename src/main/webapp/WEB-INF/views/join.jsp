      ...
      <div class="form_container">
        ...
        <form id="joinForm"
          ...
          <div class="field">
            ...
            <input type="text" id="sample6_postcode" name="zip_code"  placeholder="우편번호" readonly>
			<input type="button" onclick="sample6_execDaumPostcode()"value="우편번호 찾기"><br>
			<input type="text" id="sample6_address" name="address1" class="form-control"  placeholder="주소" readonly>
			<input type="text" id="sample6_extraAddress" name="address2" class="form-control"  placeholder="상세주소" readonly>
